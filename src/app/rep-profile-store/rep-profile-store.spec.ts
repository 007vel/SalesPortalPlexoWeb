...
function createAndSignIn(directory: RepDirectoryStore, auth: Auth, httpMock: HttpTestingController): void {
  directory
    .createRep({ name: 'Jordan Reyes', email: 'jordan@example.com', phone: '(401) 555-0148', address: '', city: '', state: '', zip: '', status: 'pending', passedCertification: false, businessCardsSent: false, consultantFeePaid: false })
    .subscribe();
