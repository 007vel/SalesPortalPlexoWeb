...
describe('AdminSettings', () => {
  ...
  beforeEach(async () => {
    ...
    httpMock.expectOne((r) => r.url === apiUrl('traininghub/filter')).flush([
      { oId: 9, roleId: null, title: 'Admin upload', category: 'Team Uploads', description: '', fileType: 'Video', fileName: 'a.mp4', length: '12 min', uploadedBy: 'Admin', uploadedAt: '2026-08-06T00:00:00Z', language: 'English' },
    ]);
